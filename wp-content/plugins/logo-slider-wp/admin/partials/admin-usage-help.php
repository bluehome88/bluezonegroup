                    ...
                    <div class="postbox">
                        <div class="inside lgx-settings-inside">
                            ...
                            <div class="lgx_row" style="width: 100%;">
                                <h1><strong>Logo Slider WP by <a href="https://logichunt.com/" target="_blank">LogicHunt.com</a></strong></h1>
                                <br>
                                ...
                                <div class="lgx_logo_slider_shortcode_copy_box" >
                                    <h3 class="lgx_logo_showcase_header">Shortcode For Specific Category</h3>
                                    <p style="padding:0 5%;"> Copy and paste this shortcode into your posts or pages. Also you can customize your shortcode param and copy from here.</p>
                                    <div class="lgx_logo_slider_shortcode_copy_wrap">
                                        <input id="logosliderwp_shortcode_copy" class="regular-text lgx_logo_slider_shortcode_copy_text" type="text" value='&#91;logo-slider cat="add_your_cat_slug"&#93;' >
                                        <button class="button button-secondary lgx_logo_slider_shortcode_copy_btn" ><i class="lgxicon lgx-icon-copy"></i> <?php _e('Copy', 'logo-slider-wp'); ?></button>
                                    </div>
                                    <p><span style="font-weight: 700;"><?php _e('Important:', 'logo-slider-wp'); ?> </span> <?php _e('All plugin default settings will be override by this shortcode parameter.', 'logo-slider-wp'); ?></p>
                                </div> <!-- // BOX -->
                            ...
                            <h3 class="clear" style="margin:  120px 0 25px 0;"><?php _e('Usage Guidelines', 'logo-slider-wp'); ?></h3>

                            <ol>
                                <li><?php _e('At first, please install and activate the plugin ', 'logo-slider-wp'); ?></li>
                            ...
                            <ul>
                                <li> <strong>*Note: You can mange logo order by drag and drop.</strong></li>
                            </ul>


                            <h3 class="clear" style="margin: 50px 0 25px 0;"><?php _e('Support', 'logo-slider-wp'); ?></h3>
                            <p><?php _e("If you need any helps, please don't hesitate to contact with us.", 'logo-slider-wp'); ?></p>
                            <a class="button " href="https://wordpress.org/support/plugin/logo-slider-wp/" target="_blank"><?php _e('Free Support', 'logo-slider-wp'); ?></a>
                            <a class="button button-primary" href="https://logichunt.com/support" target="_blank"><?php _e('Pro Support', 'logo-slider-wp'); ?></a>
