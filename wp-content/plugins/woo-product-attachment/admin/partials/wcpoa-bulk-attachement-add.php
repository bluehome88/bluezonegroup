                                    ...
                                    <div class="wcpoa-field -collapsed-target group-title" data-name="_name" data-type="text" data-key="">
                                        ...
                                        <div class="wcpoa-label attachment_name">
                                            ...
                                            <ul class="attachment_action">
                                                ...
                                                <li><a class="-minus small wcpoa-js-tooltip" href="#" data-event="remove-row" title="<?php esc_html_e('Remove',$plugin_txt_domain); ?>"><?php esc_html_e('Delete' ,$plugin_txt_domain); ?></a></li>
                                            </ul>
                                        </div>
