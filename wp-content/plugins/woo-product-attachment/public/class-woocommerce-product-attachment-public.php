...
<?php 
    ...
    public static function my_attachment_content()
    {
        //get attachments
        ...
        if ( isset( $product_id ) ) {
            echo  '<div class="woocommerce-Tabs-panel--wcpoa_product_tab custom_attachment_block">' ;
            echo  $public_plugin->wcpoa_product_tab_content( $product_id, array() ) ;
            echo  '</div>' ;
        } else {
            echo  __( '<p> Invalid product </p>', 'woocommerce-product-attachment' ) ;
        }
